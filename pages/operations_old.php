...
try {
    ...
    $stmt->execute();
    $operations = [
        ['nama_operasi' => 'Operasi Sample', 'status' => 'active', 'personnel_count' => 0, 'id' => 1]
    ];
                            ...
                            <?php else: ?>
                                <?php foreach ($operations as $operation): ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo number_format($operation['personnel_count'] ?? 0); ?> personel</td>
                                        <td><?php echo htmlspecialchars($operation['created_by_name'] ?? '-'); ?></td>
                                        <td>
                                            <div class="btn-group btn-group-sm">
                                                <button class="btn btn-info" title="Detail" onclick="viewOperation(<?php echo $operation['id'] ?? 0; ?>)">
                                                    <i class="fas fa-eye"></i>
                                                </button>
                                                <button class="btn btn-warning" title="Edit" onclick="editOperation(<?php echo $operation['id'] ?? 0; ?>)">
